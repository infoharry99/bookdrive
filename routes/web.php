...
use App\Http\Controllers\IntensivePlanController;
...
Route::get('/driving-test-form', [DrivingTestController::class, 'showForm'])->name('driving.test.form');
Route::post('/driving-test-form', [DrivingTestController::class, 'store'])->name('driving.test.store');
...
Route::get('/worldpay/success', [WorldPayController::class, 'success'])->name('worldpay.success');
Route::get('/worldpay/cancel', [WorldPayController::class, 'cancel'])->name('worldpay.cancel');
Route::get('/worldpay/pending', [WorldPayController::class, 'pending'])->name('worldpay.pending');
Route::get('/worldpay/failure', [WorldPayController::class, 'failure'])->name('worldpay.failure');
Route::get('/worldpay/error', [WorldPayController::class, 'error'])->name('worldpay.error');
Route::get('/worldpay/expiry', [WorldPayController::class, 'expiry'])->name('worldpay.expiry');

Route::post('/worldpay/callback', [WorldPayController::class, 'callback']);

// Route::post('/worldpay.success', [WorldPayController::class, 'success'])->name('worldpay.success');
...
Route::post('makearequest', [HomeController::class, 'makearequest'])->name('makearequest');
Route::get('/checkPostcode/{postcode}', [HomeController::class, 'checkPostcode']);
Route::get('advanceSearch', function(){
    return view('front-cms/advanceSearch');  // This page will include both forms
});
//rishi
//  Route::post('/storehomes', [HomeController::class, 'storehomes'])->name('storehomes');
// Route::get('/lesson-preferences', [HomeController::class, 'storeLessonPreferences'])->name('lesson-preferences');
Route::get('advanceSearch', [FormController::class, 'showForm']); // Show form
Route::post('advanceSearchForm', [FormController::class, 'store']); // Handle form submission
Route::get('/store-price-details', [FormController::class, 'storeprice'])->name('store-price-details');
Route::get('finalSearch', [FormController::class, 'AshowForm']);
Route::get('/final-search', function () {
    return view('front-cms/finalSearch');
});
Route::post('storeforms', [FormController::class, 'storeforms'])->name('storeforms');
Route::post('/check-email', [FormController::class, 'checkEmail'])->name('check.email');


Route::post('/sumbookings', [FormController::class, 'summarystore'])->name('sumbookings.store');
...
//Route::post('/storePostcodeAndMobile', [HomeController::class, 'storePostcodeAndMobile'])->name('storePostcodeAndMobile');
...
Route::group(['prefix' => 'student', 'middleware' => ['StudentAuthenticate']], function () {
    ...
    Route::get('slot', [TutorSearchController::class, 'slot'])->name('student.slot');
...
Route::group(['prefix' => 'admin', 'middleware' => ['AdminAuthenticate']], function () {
    // Admin dashboard
      Route::get('/get-tutors', [FormController::class, 'admintutorslist']);
      Route::post('/assign-tutor', [FormController::class, 'assignTutor']);
      Route::get('summary', [FormController::class, 'adminsummary'])->name('tutor.summary');
      Route::resource('intensive_plans', IntensivePlanController::class);
...
Route::group(['prefix' => 'tutor', 'middleware' => ['TutorAuthenticate']], function () {
    ...
    Route::get('profileupdate', [TutorProfileController::class, 'edit'])->name('tutor.profileupdate');
     ...
     Route::get('getClasses', [TutorProfileController::class, 'getClasses'])->name('tutor.getClasses');
...
Route::get('summary', [FormController::class, 'summary'])->name('tutor.summary');
    // Demo List
    ...
    Route::get('referral', [AssignmentsController::class, 'referral'])->name('tutor.referral');
    Route::get('theorytestschedule', [AssignmentsController::class, 'theorytestschedule'])->name('tutor.theorytestschedule');
    Route::get('practicaltestschedule', [AssignmentsController::class, 'practicaltestschedule'])->name('tutor.practicaltestschedule');
...
Route::group(['prefix' => 'parent', 'middleware' => ['StudentAuthenticate']], function () {
    Route::post('/save-slot', [SlotBookingController::class, 'store'])->name('store.slot');
    Route::post('/slotavail', [SlotBookingController::class, 'checkAvailability'])->name('save.cavailability');

    
    //rishi
    Route::post('/save-availability', [SlotBookingController::class, 'saveAvailability'])->name('save.availability');
    // student dashboard
...
Route::get('instructor', function(){
    return view('front-cms/instructor');
});


Route::get('bd_aboutUS', function(){
    return view('front-cms/bd_aboutUS');
});
...
Route::get('booknow_page1', function(){
    return view('front-cms/booknow_page1');
});


Route::get('intensive', function(){
    return view('front-cms/intensive');
});



Route::get('ourServices', function(){
    return view('front-cms/ourServices');
});



Route::get('bd_resources', function(){
    return view('front-cms/bd_resources');
});

Route::get('bd_contact', function(){
    return view('front-cms/bd_contact');
});
