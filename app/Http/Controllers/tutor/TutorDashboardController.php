...
class TutorDashboardController extends Controller
{
    ...
    $leads = TutorRequest::select('tutor_requests.*','classes.name as city_name','subjects.name as area_name')
    ->leftJoin('classes','classes.id','tutor_requests.city')
    ->leftJoin('subjects','subjects.id','tutor_requests.location')
    ->get();
            // dd($studentscount);
