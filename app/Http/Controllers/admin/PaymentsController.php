...
class PaymentsController extends Controller
{
    public function index(){
        ...
        //                  ->paginate(10);
           $payments = paymentstudents::select('paymentdetails.transaction_id as transaction_no','paymentdetails.payment_date as transaction_date','paymentdetails.payment_mode as payment_mode',
                                        'paymentdetails.amount as transaction_amount','statuses.id as transaction_status_id','statuses.name as transaction_status',
                                        'paymentdetails.remarks as remarks','studentregistrations.id as student_id','studentregistrations.name as student_name',)
                    ->join('studentregistrations','studentregistrations.id','paymentstudents.student_id')
    ...
    public function studentpayments(){
        ...
        $payments = paymentstudents::select(
                    ...
                    ->where('paymentstudents.status', 1)
                    ->paginate(10);
