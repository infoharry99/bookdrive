...
class StudentProfileController extends Controller
{
    ...
    public function rateTutor(Request $request)
    {
        ...
        TutorRating::updateOrCreate(
            ['tutor_id' => $request->tutor_id, 'student_id' => auth()->id()],
    ...
    public function getTutorRating($tutor_id)
    {
        $avgRating = TutorRating::where('tutor_id', $tutor_id)->avg('rating');
        $ratings = TutorRating::where('tutor_id', $tutor_id)->get();
