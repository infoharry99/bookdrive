...
@section('main-section')
    ...
    <div class="main-content">
            ...
            <div class="container-fluid">
                ...
                <a class="btn btn-primary" href="{{ route('tutor.studentslist') }}"><i class="fa fa-long-arrow-left"></i> My Student</a>
                    <div class="slotTitle">
                        ...
                        <button class="btn btn-sm btn-primary  bookingBtns1" style="margin-right: 5px" type="button"
                        onclick="openclassmodalcreate();"><i class="fa fa-plus"></i> &nbsp;Create Slot</button>
                    </div>
                    ...
                    <form action="{{ route('tutor.slots.search') }}" method="GET">
                        ...
                        <button class="btn btn-sm btn-primary moveRight" type="submit"><i
                            ...
                            @elseif ($slot->status == 2) --}}
                                <tr>
                                    ...
                                    <td>{{ \Carbon\Carbon::parse($slot->slot)->format('h:i A') }}</td>
                                      <td>{{ \Carbon\Carbon::parse($slot->slot_end)->format('h:i A') }}</td>
                                    @if ($slot->status == 0)
                                    ...
                                    @if ($slot->status == 0)
                                        <td><button class="btn btn-sm btn-dark"
                                                onclick="openclassmodal('{{ $slot->id }}','{{ $slot->date }}','{{ $slot->slot }}','{{ $slot->slot_end }}')">Update</button> 
        ...
        <script>
            ...
            function openclassmodal(id, date, slot,slot_end) {
                $('#slotid').val(id);
                $('#classdate').val(date);
                $('#classtime').val(slot);
                $('#forweekdiv').hide();
                $('#formonthdiv').hide();
                 $('#endtime').val(slot_end);
