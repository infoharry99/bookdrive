                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box horizontal-logo">
                            <a href="/tutor/dashboard" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="/images/logo-white.png" alt="logo" height="35">
                                </span>
                                <span class="logo-lg">

                                    <img src="/images/logo.png" alt="logo" height="17">
                                </span>
                            </a>
                            ...
                            <a href="/tutor/dashboard" class="logo logo-light">
                                ...
                                <span class="logo-lg">
                                    <img src="/images/logo-white.png" width="120px" alt="logo">
                                </span>
                            </a>
                        </div>
        ...
        <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true"
            ...
            <span class="d-flex align-items-center">
                <img class="rounded-circle header-profile-user"
                                         src="{{ $tutorProfile->profile_pic 
                                                    ? url('images/students/profilepics/' . $tutorProfile->profile_pic) 
                ...
                <ul class="navbar-nav" id="navbar-nav">
                    ...
                    <li class="nav-item">
                        ...
                        <a href="{{ route('tutor.tutorslots') }}"
                            class="nav-link menu-link{{ Request::is('tutor/tutorslots') ? 'active' : '' }}"
                    ...
                    <li class="nav-item">
                        <a href="{{ route('tutor.liveclass.classlist') }}"
                            class="nav-link  menu-link{{ Request::is('tutor/getclasslist') ? 'active' : '' }}"
                            data-key="t-horizontal">
                            <img src="/images/Tutor-Dashboard-menu-icons/My Scheduled Classes.svg" alt="">&nbsp; <span
                                data-key="t-dashboards"> Scheduled Classes</span>
                        </a>
                    </li>

   <li class="nav-item">
                        <a href="{{ route('tutor.summary') }}"
                            class="nav-link  menu-link{{ Request::is('tutor/getclasslist') ? 'active' : '' }}"
                            data-key="t-horizontal">
                            <img src="/images/Tutor-Dashboard-menu-icons/My Scheduled Classes.svg" alt="">&nbsp; <span
                                data-key="t-dashboards"> Class Request</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('tutor.studentslist') }}"
                            class="nav-link menu-link {{ Request::is('tutor/students') ? 'active' : '' }}"
                            data-key="t-horizontal">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('tutor.assignments') }}"
                            class="nav-link menu-link {{ Request::is('tutor/assignments') ? 'active' : '' }}"
                            data-key="t-dashboards">
                            <img src="/images/Tutor-Dashboard-menu-icons/My Batches.svg" alt="">&nbsp;
                            <span data-key="t-dashboards">Assignments </span>
                        </a>
                    ...
                    <!--<li class="nav-item">-->
                    <!--    <a href="{{ route('tutor.theorytestschedule') }}"-->
                    <!--        class="nav-link menu-link {{ Request::is('tutor/theorytestschedule') ? 'active' : '' }}"-->
                    <!--        data-key="t-dashboards">-->
                    <!--        <img src="/images/Tutor-Dashboard-menu-icons/My Batches.svg" alt="">&nbsp;-->
                    <!--        <span data-key="t-dashboards">Theory Test schedule </span>-->
                    <!--    </a>-->
                    <!--</li>-->

                    <!--<li class="nav-item">-->
                    <!--    <a href="{{ route('tutor.practicaltestschedule') }}"-->
                    <!--        class="nav-link menu-link {{ Request::is('tutor/practicaltestschedule') ? 'active' : '' }}"-->
                    <!--        data-key="t-dashboards">-->
                    <!--        <img src="/images/Tutor-Dashboard-menu-icons/My Batches.svg" alt="">&nbsp;-->
                    <!--        <span data-key="t-dashboards">Practical Test schedule </span>-->
                    <!--    </a>-->
                    <!--</li>-->

                    <!--<li class="nav-item">-->
                    <!--    <a href="{{ route('tutor.referral') }}"-->
                    <!--        class="nav-link menu-link {{ Request::is('tutor/referral') ? 'active' : '' }}"-->
                    <!--        data-key="t-dashboards">-->
                    <!--        <img src="/images/Tutor-Dashboard-menu-icons/My Batches.svg" alt="">&nbsp;-->
                    <!--        <span data-key="t-dashboards">Referrals </span>-->
                    <!--    </a>-->
                    <!--</li>-->
