                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box horizontal-logo">
                            <a href="/student/dashboard" class="logo logo-dark">
                                <span class="logo-sm">
                                    <!-- <h3>LOGO</h3> -->
                                    <img src="{{ url('/images/logo-white.png') }}" alt="" height="22">

                                </span>
                                <span class="logo-lg">
                                    <!-- <h3>LOGO</h3> -->
                                    <img src="{{ url('/images/logo-white.png') }}" alt="" height="17">
                                </span>
                            </a>

                            <a href="/student/dashboard" class="logo.png">
                                <span class="logo-sm">
                                    <!-- <h3>LOGO</h3> -->
                            ...
                            <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                                ...
                                <span class="d-flex align-items-center">
                                    <img class="rounded-circle header-profile-user"
                                         src=" url('images/avatar/default-profile-pic.png')"
                                         alt="Header Avatar">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('student.yourtutor') }}"
                                ...
                                <span data-key="t-starter">My Instructor </span> </a>
                        </li>
                        ...
                        <li class="nav-item ">
                            ...
                            <a href="{{ route('student.classes') }}"
                                class="nav-link menu-link{{ Request::is('student/classes') ? 'active' : '' }}" data-key="">
                                <img src="/images/Student-dashboard-menu-icon/My Scheduled Classes.svg" alt="">  &nbsp; <span
                                data-key="t-dashboards"> Schedule</span> </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('student.yourtutor') }}"
                                class="nav-link menu-link {{ Request::is('student/yourtutor') ? 'active' : '' }}">
                                <img src="/images/Student-dashboard-menu-icon/My Tutors.svg" alt="">&nbsp;
                                <span data-key="t-starter">Slots </span> </a>
                        </li>
                        <!--<li class="nav-item">-->
                        <!--    <a href="{{ route('student.slot') }}"-->
                        <!--        class="nav-link menu-link {{ Request::is('student/slot') ? 'active' : '' }}">-->
                        <!--        <img src="/images/Student-dashboard-menu-icon/Explore tutors.svg" alt="">&nbsp; <span-->
                        <!--            data-key="t-dashboards"> Slots</span> </a>-->
                        <!--</li>-->
                        ...
                        <li class="nav-item">
                            <a href="{{ route('student.mylearnings') }}"
                                ...
                                <img src="/images/Student-dashboard-menu-icon/Study Materials.svg" alt="">&nbsp; <span
                                    data-key="t-dashboards"> Learning Contents</span> </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('student.studentpayments') }}"
                                class="nav-link menu-link {{ Request::is('student/studentpayments') ? 'active' : '' }}">
                                <img src="/images/Student-dashboard-menu-icon/Payments.svg" alt="">&nbsp; <span
                                    data-key="t-dashboards"> Payments</span> </a>
                        </li>
