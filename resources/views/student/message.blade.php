            ...
            <div class="card chatPannel">
                ...
                <div class="row g-0">
                    <div class="col-12 col-lg-5 col-xl-3 border-right" >
                        <div class="m-4 adminTutorBtn">
                            <a href="{{ route('student.messages.tutor') }}"> <button
                                    class="badge bg-dark">Instructor</button></a>
                            <a href="{{ route('student.messages.admins') }}"> <button
                                    class="badge bg-dark">Admin</button></a>
                        </div>
                        <hr>
                    ...
                    <div class="col-12 col-lg-7 col-xl-9" >
                        ...
                        @endif
                        <div class="position-relative" id="chatbox" pb-2 style="height:340px">
                            ...
                            <div class="chat-message-right pb-4 chatarea" >
                                <div>
