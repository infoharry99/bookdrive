...
@section('main-section')
    ...
    <div class="main-content">
        <style>
            ...
            .tutorProftop {
                background: rgb(245, 223, 255);
                background: linear-gradient(90deg, rgba(245, 223, 255, 1) 0%, rgba(235, 242, 194, 1) 46%, rgba(255, 212, 251, 1) 100%);
            }
        </style>
                        ...
                        <div class="tu-profileview">
                            <figure>
                                ...
                                <!--    alt="image-description">-->
                                  <img class="card-img-top" src="{{ $tutorpd->profile_pic ? url('images/tutors/profilepics/' . $tutorpd->profile_pic) : url('images/avatar/default-profile-pic.png') }}"
                                 alt="image">
                            </figure>
                                ...
                                <div class="tu-protutordetail">
                                    <div class="tu-productorder-content">
                                        ...
                                        <div class="tu-product-title">
                                            <h3>{{ $tutorpd->name }} <i class="icon icon-check-circle tu-greenclr"
                                                    data-tippy-trigger="mouseenter" data-tippy-html="#tu-verifed"
                                                    data-tippy-interactive="true" data-tippy-placement="top"></i></h3>
                                        ...
                                        <div class="tu-listinginfo_price">
                                            ...
                                            <h4>£{{ $tutorpd->rate2 }}/hr</h4>
                                        </div>
                                        <div class="tu-listinginfo_price">
                                            <span>More than 9 classes</span>
                                            <h4>£{{ $tutorpd->rate3 }}/hr</h4>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tu-actionbts">
                                        ...
                                        @else
                                            <a href="/student/enrollnow/{{ $tutorpd->tutor_id }}"> <button
                                                    class="btn btn-sm btn-dark" id="enrollnow">Enroll
                                                    Now</button></a>
                                        @endif
                                        <a href="/student/tutormessages/{{ $tutorpd->tutor_id }}"><button
                                                class="btn btn-sm btn-dark">Start Chat</button></a>
                                        @if ($tutorpd->document_link_1)
                                            <div class="form-group col-md-4 mt-3">
                                                <label for="name">Certificate &nbsp;</label>
                                                <a href="{{ $tutorpd->document_link_1 }}" target="_blank"> <button
                                                        class="btn btn-sm btn-primary-tp" type="button">View</button></a>
                                            </div>
                                        @endif
                                        @if ($tutorpd->document_link_2)
                                            <div class="form-group col-md-4 mt-3">
                                                <label for="name">Certificate &nbsp;</label>
                                                <a href="{{ $tutorpd->document_link_2 }}" target="_blank"> <button
                                                        class="btn btn-sm btn-primary-tp" type="button">View</button></a>
                                            </div>
                                        @endif
                                        @if ($tutorpd->document_link_3)
                                            <div class="form-group col-md-4 mt-3">
                                                <label for="name">Certificate &nbsp;</label>
                                                <a href="{{ $tutorpd->document_link_3 }}" target="_blank"> <button
                                                        class="btn btn-sm btn-primary-tp" type="button">View</button></a>
                                            </div>
                                        @endif
                        ...
                        <div class="row">
                            <div class="col-12 mt-5">
                                ...
                                <div class="tu-description">
                                    ...
                                    <p>With over a decade of experience as a certified driving instructor, Jancy Mary has
                                        helped hundreds of learners confidently navigate the roads. Known for his patience,
                                        professionalism, and ability to tailor lessons to each student’s unique learning
                                        style, Jancy is dedicated to creating a stress-free, supportive environment for new
                                        drivers. His calm approach and in-depth knowledge make him an ideal instructor for
                                        both nervous beginners and experienced drivers looking to refine their skills.
                                        Jancy’s commitment to road safety ensures that his students not only pass their
                                        driving tests but also become responsible, defensive drivers for life.</p>
                                </div>
                            </div>


                            <div class="col-12 mt-5">
                                <div class="prfilearae">
                                    <div class="overlayTextGoal">
                                        <div class="tu-tabstitle">
                                            <h3 class="text-white">Goal</h3>
                                        </div>

                                        <div class="tu-description">
                                            <p>With over a decade of experience as a certified driving instructor, Jancy
                                                Mary has
                                                helped hundreds of learners confidently navigate the roads. Known for his
                                                patience,
                                                professionalism, and ability to tailor lessons to each student’s unique
                                                learning
                                                style, Jancy is dedicated to creating a stress-free, supportive environment
                                                for new
                                                drivers. His calm approach and in-depth knowledge make him an ideal
                                                instructor for
                                                both nervous beginners and experienced drivers looking to refine their
                                                skills.
                                                Jancy’s commitment to road safety ensures that his students not only pass
                                                their
                                                driving tests but also become responsible, defensive drivers for life.</p>
                                        </div>
                                    </div>
                                                ...
                                                <ul class="tu-icanteach">
                                                    ...
                                                    <h6>Class 9 - 10</h6>
                                                        ...
                                                        --}}
                                                                ...
                                                                {{-- <td>{{ \Carbon\Carbon::parse($achievement->date)->format('j-F-Y') }}
                                                        </td> --}}
                                                                </tr>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <i style="color: red">*Please provide your preferred time slots for the trial class. Once
                                    confirmed by the tutor, be punctual and join at the specified time.</i>
                ...
                <script>
                    ...
                    function displayAvailableSlots(slots) {
                        ...
                        for (let i = 0; i < slots.length; i++) {
                            ...
                            if ((selectedSlotIds && selectedSlotIds.includes(slots[i].id.toString())) || (
                                    storedSelectedSlotIds &&
