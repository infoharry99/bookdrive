        ...
        <div class="navbar-header">
            ...
            {{-- <a href="/student/classes" style="padding-right: 10px"> <button class="btn btn-primary">Upcoming Classes</button></a>
                        ...
                        <div class="topBlueBtn">
                            ...
                            <a href="/admin/tutors" > <button class="btn btn-primary">Trainer List</button></a>
    ...
    <div class="modal-dialog modal-dialog-centered">
        ...
        <div class="app-menu navbar-menu">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="/admin/dashboard"  class="logo logo-dark">
                    <span class="logo-sm">
                    <img src="https://bookdriver.sofinish.co.uk/frontendnew/img/logo2.png" alt="logo" height="35">
                    </span>
                    <span class="logo-lg">
                    <img src="https://bookdriver.sofinish.co.uk/frontendnew/img/logo2.png" alt="logo" height="17">
                    </span>
                </a>
                <!-- Light Logo-->
                <a href="/admin/dashboard"  class="logo logo-light">
                    ...
                    <span class="logo-lg">
                    <img src="https://bookdriver.sofinish.co.uk/frontendnew/img/logo2.png" width="120px" alt="logo">
                    </span>
                </a>
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                           ...
                           <li class="nav-item">
                                ...
                                @endphp
                                    <a href="{{route('admin.leads')}}" class="nav-link {{ Request::is('admin/leads') ? 'active' : '' }}" data-key="t-one-page"><i class="ri-rocket-line"></i><span data-key="t-landing">Leeds</span> </a>
                        ...
                        @endphp
                            ...
                            <div class="collapse menu-dropdown {{ $isMasterActive ? 'show' : '' }}" id="sidebarPages">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item ">
                                        <a href="{{url('admin/intensive_plans')}}" class="nav-link {{ Request::is('admin/intensive_plans') ? 'active' : '' }}" data-key="t-starter"> Insentive Plans </a>
                                    </li>
                                    <li class="nav-item ">
                                        <a href="{{url('admin/summary')}}" class="nav-link {{ Request::is('admin/summary') ? 'active' : '' }}" data-key="t-starter"> Insentive Request </a>
                                    </li>
                                    <li class="nav-item ">
                                        <a href="{{route('admin.class')}}" class="nav-link {{ Request::is('admin/class') ? 'active' : '' }}" data-key="t-starter"> City </a>
                                    </li>
                                    {{-- <li class="nav-item">
                        ...
                        @endphp
                            ...
                            <!--</div>-->
                                        ...
                                        <a href="{{route('admin.students')}}" class="nav-link {{ Request::is('admin/students') ? 'active' : '' }}" data-key="t-starter"><i class="ri-rocket-line"></i><span data-key="t-landing"> Student List</span> </a>
                        ...
                        @endphp
                            ...
                            <!--    <ul class="nav nav-sm flex-column">-->
                            <!--        <li class="nav-item">-->
                            <!--            <a href="{{route('admin.tutors')}}" class="nav-link {{ Request::is('admin/tutor') ? 'active' : '' }}" data-key="t-one-page"> Trainer List </a>-->
                            <!--        </li>-->
                            ...
                            <!--</div>-->
                                        ...
                                        <a href="{{route('admin.tutors')}}" class="nav-link {{ Request::is('admin/tutor') ? 'active' : '' }}" data-key="t-one-page"><i class="ri-rocket-line"></i><span data-key="t-landing"> Trainer List</span> </a>
                                    </li>
                        ...
                        @endphp
                            ...
                            <li class="nav-item">
                            @php
                                $DriveTestActive = Request::is('admin/requests');
                            @endphp
                            <a class="nav-link menu-link" href="#requestsAdvanceUIOT" data-bs-toggle="collapse" role="button" aria-expanded="{{ $DriveTestActive ? 'true' : 'false' }}" aria-controls="requestsAdvanceUI">
                                <i class="ri-stack-line"></i> <span data-key="t-advance-ui">Early Drive Request</span>
                            </a>
                            <div class="collapse menu-dropdown {{ $DriveTestActive ? 'show' : '' }}" id="requestsAdvanceUIOT">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{ route('admin.requests') }}" class="nav-link {{ Request::is('admin/requests') ? 'active' : '' }}" data-key="t-alerts">Test Drive Request</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        @php
                            ...
                            <div class="collapse menu-dropdown {{ $isPayActive ? 'show' : '' }}" id="sidebarFormsPay">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('admin.tutorpaymentslist')}}" class="nav-link {{ Request::is('admin/tutorpaymentslist') ? 'active' : '' }}" data-key="t-form-select"> Trainer Payment </a>
                                    </li>
                                    <li class="nav-item">
