                                ...
                                <td><a href="#"
                                    ...
                                    <td><a href="#"
                                            ...
                                            {{ $ttrlist->admin_commission }}% <span class="badge bg-primary ml-3">
                                                Update</span> </a></td>
                                    <td>
                                        <span class="badge bg-success ml-3">{{ $ttrlist->driver_payment }}</span> 
                                    </td>
                                    <td>
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#tutorModal{{ $ttrlist->tutor_id }}">
                                            <span class="badge {{ strtotime($ttrlist->badge_expiry_date) < strtotime(now()) ? 'bg-danger' : 'bg-success' }}">
                                                {{ $ttrlist->badge_expiry_date }}
                                            </span>
                                        </a>
                                    </td>
                                    <div class="modal fade" id="tutorModal{{ $ttrlist->tutor_id }}" tabindex="-1" aria-labelledby="tutorModalLabel{{ $ttrlist->tutor_id }}" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="tutorModalLabel{{ $ttrlist->tutor_id }}">Tutor Badge Details</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body text-center">
                                                    <p><strong>Expiry Date:</strong> {{ $ttrlist->badge_expiry_date }}</p>
                                                    <img src="{{ asset($ttrlist->badge_image) }}" class="img-fluid rounded" alt="Badge Image" style="max-width: 100%;">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
