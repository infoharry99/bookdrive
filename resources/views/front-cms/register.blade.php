        ...
        <div class="container">
            ...
            <div class="row mt-5">
                <div class="col-lg-7 col-md-12 col-sm-12 col-xs-12">
                    <div class="registop ">
                        <h1 class="">
                        Get Started Today:<br> Register for Your Driving Lessons
                        </h1>
                        <img src="{{url('frontendnew/img/blog-1.jpg')}}" width="100%" alt="">

                        <p class="charcol mt-4"><b>"Join Book Driver: Become an Instructor and Shape Future Drivers"</b><br>
                        At Book Driver, we’re looking for passionate driving instructors who want to inspire and educate the next generation of safe drivers. Enjoy the flexibility of setting your own schedule, competitive earnings, and the satisfaction of helping learners gain confidence and independence on the road."</p>
                        ...
                        <form action="{{url('/student/register')}}" method="POST" class="">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="mobile" name="mobile" aria-describedby=""
                                    placeholder="Your mobile number" value="{{old('mobile')}}" maxlength="11" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                                <span class="text-danger error-message">
                                    @error('mobile')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="radioBtn">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="radioLogin tutor active-btn">
                                            <input type="radio" value="tutor" name="registerAs" id="tutor" checked>
                            ...
                            <div class="row mt-4">
                                <div class="col-12 ">
                                    <div class="regSub">
                                        <button type="submit" class="btn btn-lg btn-warning text-dark">Create</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="haveAnAccount">
                                <p>Already have an account <a href="#" class="text-warning" data-toggle="modal" data-target="#loginPopup" onclick="openLogin();"><u>Login now</u></a></p>
                            </div>
